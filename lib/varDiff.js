...
/* Когда stratum-сервер начинает свою работу (см. функцию StartStratumServer в файле pool.js), и на сервер приходит сигнал 'client.connected'
(см. в той же функции), то для нового подключившегося майнера эта функция сгенерит для него сложность и пошлет сигнал (emit 'newDifficulty'),
который будет зарегестрирован в функции setVarDiff файла pool.js*/
