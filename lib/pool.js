...
var address = require('ethereum-address');
...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function DetectCoinData(finishedCallback) {
        ...
        _this.daemon.batchCmd(batchRpcCalls, function (error, results) {
            ...
            options.difficulty = bignum(rpcResults.eth_getBlockByNumber.difficulty, 16);
        ...
        function getBlockTemplate(callback) {
            _this.daemon.cmd('eth_getBlockByNumber',
                ...
                function (result) {
                    ...
                    var blockTemplate = result[0].response;
            ...
            _this.daemon.cmd('eth_getWork',
                ...
                function (result) {
                    if (result.error) {
                        ...
                        response.pendingReply = blockTemplate;
